                    ...
                    <center>
                         ...
                         <table align = 'centre' cellpadding = '2'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input style="padding-left:10px;width:200px; height:30px" name="phone" type="text" placeholder="XXX-XXX-XXXX" value="<?php echo $_SESSION['phone'] ?>">
                                </td> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="Sbtn" type="submit" value="Continue">  
                                </td>
