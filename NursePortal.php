        ...
        <div id="addP">
          <center>
                <table style="z-index:-1" >
                    ...
                    <tr>
                        <td colspan="2">
                             <form method="POST" action="LogPatient.php">
                     ...
                     <tr>
                            <td colspan="2">
                             <form method="POST" action="SearchPatients.php">
                    ...
                    <tr>
                        <td colspan="2">
                             <form method="POST" action="ViewAppointment.php">
                                <button style="width:800px;height:60px" id="getStarted1"><img src="Images/AviewU.png" align="middle" alt="facebook logo" width="50" height="40" style=" z-index: 1000; right:0" >&nbsp;View Appointments&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                             </form>
                        </td>
                     </tr>
                     <tr>
