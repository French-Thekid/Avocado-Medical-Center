<?php
    ...
    else if(isset($_POST['SLbtn']))
    {
        ...
        if(($key=="")||(is_numeric($key)))
        {
            ...
            header("refresh:0; url=DSearchPatient.php");
        }
        else{
            $errKey="";
            $_SESSION['Errkey']=$errKey;
            ...
            if( $_SESSION['e']=="")
            {
                ...
                $_SESSION['Errkey']=$errKey;
                header('Location: DSearchPatient.php');
            }
            else{
                $errKey="";
                $_SESSION['Errkey']=$errKey;
                $_SESSION['test']=="YES";
                header('Location: DSearchPatient.php?Fnd=1');
            }
         }
    ...
    else if(isset($_POST['SFbtn']))
        {
            ...
            if(($key=="")||(is_numeric($key)))
            {
                ...
                if( $_SESSION['e']=="")
                {
                    ...
                    $_SESSION['Errkey']=$errKey;
                    $_SESSION['test']=="YES";
                    header('Location: DSearchPatient.php?Fnd=2');
                }
             }
