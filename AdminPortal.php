                    ...
                    <tr>
                        <td>
                             <form method="POST" action="addUser.php">
                                <button style="width:800px" id="getStarted1"><img src="Images/AaddU.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >
                    ...
                    <tr>
                        <td colspan="2">
                             <form method="POST" action="EditStaff.php">
                                <button style="width:800px" id="getStarted1"><img src="Images/AEditU.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >Edit User Accounts</button>
                             </form>
                        </td>
                     </tr>
                     <tr>
                            <td colspan="2">
                             <form method="POST" action="deleteUser.php">
                                <button style="width:800px" id="getStarted1"><img src="Images/AdeleteU.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >Delete User Account</button>
                             </form>
                            </td>
                    </tr>
               </table>
