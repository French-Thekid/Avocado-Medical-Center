                    ...
                    <center>
                         ...
                         <table align = 'centre' cellpadding = '2'>
                            ...
                            <tr style="font-size:20px;text-shadow:1px 1px black;color:white;border-top:1px solid White;">
                                ...
                                <th style="border-right:1px solid white">Appointment Staff Name</th>
                            ...
                            <tr>
                                <td>
                                    <input style="padding-left:10;width:150px;" type="text" name="key" placeholder="Patient TRN" value=""/>
                                </td> 
                                 <td>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <textarea style="padding-left:5px;font-family:serif; border:1px solid clear;font-size:14px;" value="" name="reason" rows="3" cols="100"><?php echo $_SESSION['aReason']; ?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td> 
                                  <input style="height:30px;width:150px;" type="reset" value="Clear"> 
                                </td>
                                <td>
                                    <input style="height:30px;width:150px;" name="Bbtn" type="submit" value="Return">  
                                </td>
                                <td>
                                    <input style="height:30px;width:150px;" name="Lbtn" type="submit" value="Update Status">  
                                </td>
